    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/categoryHouseRooms/list").permitAll()
                        .requestMatchers("/categoryProduct/list").permitAll()
                        .requestMatchers("/categoryStatus/list").permitAll()
                        .requestMatchers("/provinces/country/*").permitAll()
                        ...
                        //.requestMatchers("/sales/selledlist").permitAll()
