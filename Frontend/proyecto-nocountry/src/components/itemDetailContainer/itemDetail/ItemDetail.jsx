    ...
    <div className='detail-component'>
      <div className="detail-container">
        <div className="detail-img-container">
          <img src='https://d2oo5quzpsdib.cloudfront.net/Website/General/Standard-Product-Icon-500.png' alt="img 1" />
        </div>
        <div className="detail-data-container">
          <div className="detail-product-container">
            ...
            <div className='card_product-favorite' onClick={handleFavorite}>
              {favorite == false ? <StarBorderIcon sx={{ fontSize: 40 }} ></StarBorderIcon> : <StarIcon sx={{ fontSize: 40 }} ></StarIcon>}
            </div>
          </div>
          <div className="detail-owner-container">
            ...
            <div className="detail-owner-button">
              <Button variant='contained'>Acordar compra con el vendedor</Button>
